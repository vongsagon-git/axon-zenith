...
```
╔═══════════════════════════════════════════════════════════════════════╗
║  💡 USER สามารถพิมพ์ได้ตลอดเวลา - ไม่ต้องใช้คำสั่งพิเศษ!              ║
╠═══════════════════════════════════════════════════════════════════════╣
║                                                                       ║
║  📝 วิธีให้ใบ้ (พิมพ์เลย):                                             ║
║     • "เพิ่ม dark mode ด้วย"                                          ║
║     • "ลองดู auth ด้วยนะ"                                             ║
║     • "อย่าลืม test"                                                  ║
║     • "ใช้ Zustand แทน Redux"                                         ║
║     • "priority login ก่อน"                                           ║
║                                                                       ║
║  🔄 Claude จะ:                                                        ║
║     1. รับใบ้ทันที                                                    ║
║     2. เพิ่ม task ใหม่ใน MAP (ถ้าเป็นงานใหม่)                         ║
║     3. ปรับ priority (ถ้า user ระบุ)                                  ║
║     4. บันทึกใน Memory MCP                                            ║
║     5. ทำงานต่อไม่หยุด                                                ║
║                                                                       ║
║  ⚡ ตัวอย่าง Flow:                                                     ║
║     User: /axon:ignite                                                ║
║     Claude: [เริ่มทำ task T001...]                                    ║
║     User: "เพิ่ม validation ด้วย"                                     ║
║     Claude: ✅ รับใบ้! เพิ่ม [T005] Add validation ใน MAP              ║
║     Claude: [ทำ T001 ต่อ... เสร็จแล้วไป T002...]                      ║
║                                                                       ║
║  🛑 หยุดทำงาน:                                                         ║
║     • พิมพ์ "หยุด" / "stop" / "พอ"                                   ║
║                                                                       ║
